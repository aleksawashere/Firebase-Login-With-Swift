...
struct DynamicFilterViewGuest<Content: View,T>: View where T: NSManagedObject {
    ...
    init(dateToFilter: Date, @ViewBuilder content: @escaping (T)->Content){
        ...
        _request = FetchRequest(entity: T.entity(), sortDescriptors: [.init(keyPath: \ZadatakGuest.taskDate, ascending: false)], predicate: predicate)
